...
#ifndef EDITOREXPONENTMODULE_H
#define EDITOREXPONENTMODULE_H

#include <editorModule.h>

class EditorExponentModule : public EditorModule
{
	public:
		EditorExponentModule();
	...
	protected:
	private:
		noisepp::ExponentModule2D mModule2D;
		noisepp::ExponentModule3D mModule3D;
};

#endif // EDITOREXPONENTMODULE_H
