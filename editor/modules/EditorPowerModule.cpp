...
#include "EditorPowerModule.h"

std::string EditorPowerModule::FACTORY_NAME = "Power";

EditorPowerModule::EditorPowerModule() : EditorModule(2)
{
}

void EditorPowerModule::fillPropertyGrid (wxPropertyGrid *pg)
{
...
void EditorPowerModule::onPropertyChange (wxPropertyGrid *pg, const wxString &name)
{
...
bool EditorPowerModule::validate (wxPropertyGrid *pg)
{
	bool valid = true;
...
void EditorPowerModule::writeProperties (TiXmlElement *element)
{
	writeSourceModules (element);
}

bool EditorPowerModule::readProperties (TiXmlElement *element)
{
