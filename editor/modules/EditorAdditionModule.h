...
#ifndef EDITORADDITIONMODULE_H
#define EDITORADDITIONMODULE_H

#include <editorModule.h>

class EditorAdditionModule : public EditorModule
{
	public:
		EditorAdditionModule();
	...
	protected:
	private:
		noisepp::AdditionModule mModule;
};

#endif // EDITORADDITIONMODULE_H
