...
#ifndef EDITORMAXIMUMMODULE_H
#define EDITORMAXIMUMMODULE_H

#include <editorModule.h>

class EditorMaximumModule : public EditorModule
{
	public:
		EditorMaximumModule();
	...
	protected:
	private:
		noisepp::MaximumModule mModule;
};

#endif // EDITORMAXIMUMMODULE_H
