...
#ifndef EDITORSCALEBIASMODULE_H
#define EDITORSCALEBIASMODULE_H

#include <editorModule.h>

class EditorScaleBiasModule : public EditorModule
{
	public:
		EditorScaleBiasModule();
	...
	protected:
	private:
		noisepp::ScaleBiasModule2D mModule2D;
		noisepp::ScaleBiasModule3D mModule3D;
};

#endif // EDITORSCALEBIASMODULE_H
