...
#ifndef EDITORTRANSLATEPOINTMODULE_H
#define EDITORTRANSLATEPOINTMODULE_H

#include <editorModule.h>

class EditorTranslatePointModule : public EditorModule
{
	public:
		EditorTranslatePointModule();
	...
	protected:
	private:
		noisepp::TranslatePointModule2D mModule2D;
		noisepp::TranslatePointModule3D mModule3D;
};

#endif // EDITORTRANSLATEPOINTMODULE_H
