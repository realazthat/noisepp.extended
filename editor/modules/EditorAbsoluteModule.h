...
#ifndef EDITORABSOLUTEMODULE_H
#define EDITORABSOLUTEMODULE_H

#include <editorModule.h>

class EditorAbsoluteModule : public EditorModule
{
	public:
		EditorAbsoluteModule();
	...
	protected:
	private:
		noisepp::AbsoluteModule mModule;
};

#endif // EDITORABSOLUTEMODULE_H
