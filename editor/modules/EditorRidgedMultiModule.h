...
#ifndef EDITORRIDGEDMULTIMODULE_H
#define EDITORRIDGEDMULTIMODULE_H

#include <editorModule.h>

class EditorRidgedMultiModule : public EditorModule
{
	public:
		EditorRidgedMultiModule();
	...
	protected:
	private:
		noisepp::RidgedMultiModule2D mModule2D;
		noisepp::RidgedMultiModule3D mModule3D;
};

#endif // EDITORRIDGEDMULTIMODULE_H
