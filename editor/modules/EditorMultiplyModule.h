...
#ifndef EDITORMULTIPLYMODULE_H
#define EDITORMULTIPLYMODULE_H

#include <editorModule.h>

class EditorMultiplyModule : public EditorModule
{
	public:
		EditorMultiplyModule();
	...
	protected:
	private:
		noisepp::MultiplyModule mModule;
};

#endif // EDITORMULTIPLYMODULE_H
