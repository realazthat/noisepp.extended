...
#ifndef EDITORCONSTANTMODULE_H
#define EDITORCONSTANTMODULE_H

#include <editorModule.h>

class EditorConstantModule : public EditorModule
{
	public:
		EditorConstantModule();
	...
	protected:
	private:
		noisepp::ConstantModule2D mModule2D;
		noisepp::ConstantModule3D mModule3D;
};

#endif // EDITORCONSTANTMODULE_H
