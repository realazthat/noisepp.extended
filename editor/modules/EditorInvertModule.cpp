...
#include "EditorInvertModule.h"

std::string EditorInvertModule::FACTORY_NAME = "Invert";

EditorInvertModule::EditorInvertModule() : EditorModule(1)
{
}

void EditorInvertModule::fillPropertyGrid (wxPropertyGrid *pg)
{
	pg->Append( wxPropertyCategory(wxT("Source modules")) );
	appendSourceModuleProperty (pg, wxT("Source module"), mSourceModules[0]);
}

void EditorInvertModule::onPropertyChange (wxPropertyGrid *pg, const wxString &name)
{
...
bool EditorInvertModule::validate (wxPropertyGrid *pg)
{
	bool valid = true;
...
void EditorInvertModule::writeProperties (TiXmlElement *element)
{
	writeSourceModules (element);
}

bool EditorInvertModule::readProperties (TiXmlElement *element)
{
