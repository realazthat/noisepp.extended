...
#ifndef EDITORCHECKERBOARDMODULE_H
#define EDITORCHECKERBOARDMODULE_H

#include <editorModule.h>

class EditorCheckerboardModule : public EditorModule
{
	public:
		EditorCheckerboardModule();
	...
	protected:
	private:
		noisepp::CheckerboardModule2D mModule2D;
		noisepp::CheckerboardModule3D mModule3D;
};

#endif // EDITORCHECKERBOARDMODULE_H
