...
#ifndef EDITORBILLOWMODULE_H
#define EDITORBILLOWMODULE_H

#include <editorModule.h>

class EditorBillowModule : public EditorModule
{
	public:
		EditorBillowModule();
	...
	protected:
	private:
		noisepp::BillowModule2D mModule2D;
		noisepp::BillowModule3D mModule3D;
};

#endif // EDITORBILLOWMODULE_H
