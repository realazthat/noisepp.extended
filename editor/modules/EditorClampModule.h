...
#ifndef EDITORCLAMPMODULE_H
#define EDITORCLAMPMODULE_H

#include <editorModule.h>

class EditorClampModule : public EditorModule
{
	public:
		EditorClampModule();
	...
	protected:
	private:
		noisepp::ClampModule2D mModule2D;
		noisepp::ClampModule3D mModule3D;
};

#endif // EDITORCLAMPMODULE_H
