...
#include "EditorMultiplyModule.h"

std::string EditorMultiplyModule::FACTORY_NAME = "Multiply";

EditorMultiplyModule::EditorMultiplyModule() : EditorModule(2)
{
}

void EditorMultiplyModule::fillPropertyGrid (wxPropertyGrid *pg)
{
...
void EditorMultiplyModule::onPropertyChange (wxPropertyGrid *pg, const wxString &name)
{
...
bool EditorMultiplyModule::validate (wxPropertyGrid *pg)
{
	bool valid = true;
...
void EditorMultiplyModule::writeProperties (TiXmlElement *element)
{
	writeSourceModules (element);
}

bool EditorMultiplyModule::readProperties (TiXmlElement *element)
{
