...
#ifndef EDITORINVERTMODULE_H
#define EDITORINVERTMODULE_H

#include <editorModule.h>

class EditorInvertModule : public EditorModule
{
	public:
		EditorInvertModule();
	...
	protected:
	private:
		noisepp::InvertModule mModule;
};

#endif // EDITORINVERTMODULE_H
