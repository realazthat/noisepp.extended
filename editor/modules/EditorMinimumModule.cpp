...
#include "EditorMinimumModule.h"

std::string EditorMinimumModule::FACTORY_NAME = "Minimum";

EditorMinimumModule::EditorMinimumModule() : EditorModule(2)
{
}

void EditorMinimumModule::fillPropertyGrid (wxPropertyGrid *pg)
{
...
void EditorMinimumModule::onPropertyChange (wxPropertyGrid *pg, const wxString &name)
{
...
bool EditorMinimumModule::validate (wxPropertyGrid *pg)
{
	bool valid = true;
...
void EditorMinimumModule::writeProperties (TiXmlElement *element)
{
	writeSourceModules (element);
}

bool EditorMinimumModule::readProperties (TiXmlElement *element)
{
